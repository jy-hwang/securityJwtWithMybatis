...
public class MemberAuthService {
  ...
  @Transactional
  public AuthDto.TokenDto login(RequestLogin loginDto) {
  ...
  public AuthDto.TokenDto reissue(String requestAccessTokenInHeader, String requestRefreshToken) {
      ...
      AuthDto.TokenDto tokenDto = tokenProvider.createToken(principal, authorities);
  ...
  public AuthDto.TokenDto generateToken(String provider, String email, String authorities) {
      ...
      AuthDto.TokenDto tokenDto = tokenProvider.createToken(email, authorities);
